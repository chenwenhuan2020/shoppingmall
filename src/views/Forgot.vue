<template>
  <div class="login">
    <van-nav-bar @click-right="goState">
      <template #left>
          <div class="left">
            <img
              class="auto-img"
    ...
    <div class="user-box">
      ...
      <van-form v-show="!isNext">
        ...
        >
        <template #button>
          <van-button size="small" color="skyblue" :disabled="isSend" @click="getValidCode">{{text}}</van-button>
        </template>
        </van-field>
        <div class="forgot">
        ...
        <div class="commit-btn">
          <van-button @click="next" round block color="#0C34BA"> 下一步</van-button>
        </div>
      </van-form>
      ...
      <van-form v-show="isNext">
        ...
        <div class="commit-btn">
          <van-button round block color="#0C34BA" @click="commit" > 提交 </van-button>
        </div>
        <div class="commit-btn">
