<template>
  <div class="detail">
    <van-nav-bar title="商品详情" fixed @click-left="back(pid)">
      <template #left>
        <div class="left-img">
          <img src="../assets/images/fh.png" class="auto-img" alt="" />
        </div>
      </template>
    </van-nav-bar>
    <div>
    ...
    <van-goods-action>
      <van-goods-action-icon
        ...
        :color="bagCount > 0 ? '#f0134d' : '#646566'"
      />
      <van-goods-action-icon
        icon="like"
        :text="isLike ? '已收藏' : '未收藏'"
        :color="isLike ? '#f0134d' : '#646566'"
...
.detail /deep/ .van-info {
  background-color: #f0134d;
}
.detail /deep/ .van-stepper--round .van-stepper__plus {
  background-color: #f0134d;
}
</style>
